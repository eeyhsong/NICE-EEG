...
try channel attention

how about before temporal conv?
"""
...
os.environ['CUDA_DEVICE_ORDER'] = 'PCI_BUS_ID'
os.environ["CUDA_VISIBLE_DEVICES"] = ','.join(map(str, gpus))
result_path = '/home/yhsong/Documents/Code/NICE/results/fs250/ch_att/channel_att/pre_temporal/test1/' 
model_idx = 'gg'
trial_shape = (63, 1440)
...
class IE():
    def __init__(self, args, nsub):
        ...
        summary(self.Enc_eeg, (1, 63, 250))

        # test_input = torch.randn(1, 1, 63, 250)
        # test_input = Variable(test_input.cuda().type(self.Tensor))
        # flops, params = profile(self.Enc_eeg, inputs=(test_input, ))
