...
os.environ['CUDA_DEVICE_ORDER'] = 'PCI_BUS_ID'
os.environ["CUDA_VISIBLE_DEVICES"] = ','.join(map(str, gpus))
result_path = '/home/songyonghao/Documents/Code/NICE/results/Conf/frequency/cheby2/gamma/' 
model_idx = 'gam'
...
class IE():
    ...
    def get_eeg_data(self):
        ...
        from scipy.signal import butter, filtfilt, cheby2, cheby1, cheb1ord
        ...
        # b, a = cheby2(order, 40, [low, high], btype='bandpass', analog=False)
        ...
        # b, a = cheby1(N, 0.05, Wn, btype='bandpass', analog=False, output='ba')
        ...
        for i in range(len(train_data)):
            train_data[i, 0, :, :] = filtfilt(b, a, train_data[i, 0, :, :])
        for i in range(len(test_data)):
            test_data[i, 0, :, :] = filtfilt(b, a, test_data[i, 0, :, :])
